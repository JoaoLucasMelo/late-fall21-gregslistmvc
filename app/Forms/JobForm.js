...
<form onsubmit="app.jobsController.createJob()">
  ...
  <div class="form-check">
    <input class="form-check-input" type="radio" name="salary" value="option1" id="salary1">
    <label class="form-check-label" for="salary1">
      Salary
    </label>
  </div>
  <div class="form-check">
    <input class="form-check-input" type="radio" name="salary" value="option2" id="salary2">
  ...
  <div class="mb-3">
    <div>
      <label for="pay" class="form-label">Pay $</label>
      <input type="number" class="form-control" name="pay" id="pay" aria-describedby="pay" placeholder="pay..."
        required>
    </div>
  </div>
  <div class="mb-3 mt-2">
